    ...
    def face_recog(self):
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                my_cursor.execute("Select Emp_name from employee where employee_id=" + str(id))
                i = my_cursor.fetchone()
                i = "+".join(i) if i else "Unknown"

                my_cursor.execute("Select jobtitle from employee where employee_id=" + str(id))
        ...
        while True:
            ...
            # Close window on 'Enter' or 'Esc' key or by clicking 'X'
